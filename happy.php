...
<body>
    ...
    <!-- Page Header Start -->
    <div class="container-fluid page-header-3 py-5 mb-5">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Help For Happiness</h1>
            ...
            <div class="row g-0 mx-lg-0">
                ...
                <div class="col-lg-6 pe-lg-0" style="min-height: 350px;">
                    <div class="position-relative h-100" >
                        <img  style="padding-top: 60px;" crossorigin="anonymous"  src="./img/happiness.jpg" height="600px">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a class="border-bottom" href="#">Ramo</a>, All Right Reserved.
                    </div>
