                ...
                <div class="row">
                  ...
                  <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <?php
                              if (isset($_REQUEST['show_pair_date'])) {
                                $t_j_o_g_d=mysqli_fetch_array(mysqli_query($conn,"SELECT count(user_id) total_userid FROM `users` WHERE `registration_date`='$pair_date'"));
                                $t_p_c=mysqli_fetch_array(mysqli_query($conn,"SELECT sum(no_of_pair) total_pair FROM `pair_count` WHERE `date`='$pair_date'"));
                                echo "total AMT FOR PAIR : ".$total_amt=$t_j_o_g_d['total_userid']*50;
                                echo "<br>TOTAL PAIR GENERATED :".$total_pair=$t_p_c['total_pair'];
                                echo "<br> ONE PAIR VALUE :".$one_pair_amt=floor($total_amt/$total_pair);
                              }
                             ?>
                            <div class="card-body">
