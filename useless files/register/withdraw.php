                                  ...
                                  <div class="card-body">
                                      <form method="post" action="element/redirect.php" id="basicform" data-parsley-validate="">
                                          <div class="form-group">
                                              ...
                                              <input type="number" required="" class="form-control" value="" name="amount">
                                              <input type="text" required="" class="form-control" value="<?php echo $my_id ?>" name="user_id" hidden>
                                          </div>
                                          <div class="row">
                                              <div class="col-sm-6">
                                                  <button type="submit" name="withdrawl_request" class="btn btn-space btn-primary">Submit</button>
                                              </div>
                                          </div>
                                      </form>
                                  </div>
